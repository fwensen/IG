...
public class TrafficActivity extends TabActivity{
	...
	private RadioButton tab_icon_train, tab_icon_plane, tab_icon_steamer,tab_icon_subwayair;
	 @Override
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        tab_icon_subwayair = (RadioButton) findViewById(R.id.tab_icon_subway_air);
	        ...
	        tabhost.addTab(tabhost.newTabSpec("tag4").setIndicator("2").setContent(new Intent(this,SubwayAirLineShowActivity.class)));
